...
from dock_visualization import FLOW_LINE_CAPTION, HOT_LANE_CAPTION, LABEL_DENSITY_CAPTION, build_hall_figure


def render_assignment_panel(prefix, label, assignment, positions, flow, hall_width, hall_depth, hot_lane_idxs):
    ...
    fig = build_hall_figure(positions, assignment, flow, hall_width, hall_depth, hot_lane_idxs)
    ...
    pdf_bytes = generate_assignment_plan_pdf(label, assignment, positions, flow)
    st.download_button(
